class Account:
    ...
    def time_to_retire(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        '''
        t = self.balance*(1+self.interest)
        log_result = math.log(amount, t)
        return math.ceil(log_result) + 1
        '''
        increase = self.balance
        years = 0
        while increase < amount:
            increase += self.interest * increase
            years += 1
        return years
